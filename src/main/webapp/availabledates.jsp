      ...
      <div class="col-3">
        <svg xmlns="http://www.w3.org/2000/svg" width="158" height="117" viewBox="0 0 158 117">
          ...
          <g id="Group_16" data-name="Group 16" transform="translate(-497 -255)">
            ...
            <text id="ROOMS_OFFERS" data-name="ROOMS &amp; OFFERS" class="cls3" transform="translate(576 367)"><tspan x="-35" y="0">DETAILS</tspan></text>
          </g>
        </svg>
      </div>
      <div class="col-3">
...
<%--            </tbody>--%>
    ...
    <p>The above rates are calculated based on a single or twin occupancy and on the lowest available rate on 
      the requested dates. These rates are only guaranteed upon a confirmed reservation.
    </p>
  </form>
  </div>
  <!--prefooter here-->
