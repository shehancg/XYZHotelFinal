        ...
        <div class="container ov1">
          ...
          <br>
            ...
            <div class="container sdbox">
                ...
                <div class="row sdboxrw2">
                    ...
                    <div class="col-3">
                        <div class="row">
                            <div class="col-md-12 mb-4" style="padding-top: 120px;">
                                <div class="card" >
          ...
          <div class="container sdbox">
            ...
            <div class="row">
              <div class="col"></div>
              <div class="col">
                <button type="button" class="form-control btn nextbtn" ><a href="/availabledates" style="color: white;font-style: normal;">BOOK NOW</a></button>
              </div>
              <div class="col"></div>
            </div>
            </form>
