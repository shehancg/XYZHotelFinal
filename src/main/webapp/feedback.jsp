...
<nav class="navbar1 navbar-expand-sm fixed-top navbar-dark">
    ...
    <div class="container-fluid top st_p_content">
        <div class="container">
            ...
            <div class="row fbrow">
                <div class="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 col-xxl-4"></div>
                <div class="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 col-xxl-4 fbform">
                    <h4>Hi User Name ! </h4>
                    <h4>Give your feedback about us</h4>
                    <hr>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-4"></div>
                        <div class="col-4"><input type="submit" class="btn p_fbsumbit" value="Submit"></div>
                        <div class="col-4"></div>
                    </div>
